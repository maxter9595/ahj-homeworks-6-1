...
;// CONCATENATED MODULE: ./src/js/TrelloBoard.js
class TrelloBoard {
  constructor() {
  ...
  createCard(columnId, cardText, index) {
    ...
    deleteButton.addEventListener("click", () => this.deleteCard(columnId, index));
  ...
  dropCard(e, column) {
    ...
    const cardText = this.draggedCard.textContent.replace("✖", "").replace("✎", "").trim();
...
/* harmony default export */ const js_TrelloBoard = (TrelloBoard);
